...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  List<CustomWidgetData> thirdColumn = [
    CustomWidgetData(number: '3.', description: '\n\n\n Mit nur einem Klick \n bewerben', image: 'assets/3/1.svg'),
    CustomWidgetData(
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Text(
                          "  Login    ",
                          style: Ts.semiBold14(color: Color(0xff319795)),
                        ),
                      ),
                    ],
                  )
          ...
          bottomNavigationBar: MediaQuery.of(context).size.width < 689 ? customBottomNavigationBar() : null,
          body: Container(
            child: Column(
              children: [
                Expanded(child: MediaQuery.of(context).size.width < 689 ? HomeBody(context) : HomeBodyWeb(context)),
              ],
            ),
          )),
    );
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Arbeitnehmer",
                        style: TextStyle(fontSize: 17, color: idx == 0 ? Colors.white : Color(0xff319795)),
                      ),
                      width: 215,
                      height: 40,
                      decoration: BoxDecoration(
                        color: idx == 0 ? Color(0xff81E6D9) : Colors.transparent,
                        border: Border.all(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Arbeitgeber",
                        style: TextStyle(fontSize: 17, color: idx == 1 ? Colors.white : Color(0xff319795)),
                      ),
                      width: 215,
                      height: 40,
                      decoration: BoxDecoration(
                        color: idx == 1 ? Color(0xff81E6D9) : Colors.transparent,
                        border: Border.all(
                          color: Color(0xffCBD5E0),
                          width: 1,
                        ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Temporärbüro",
                        style: TextStyle(fontSize: 17, color: idx == 2 ? Colors.white : Color(0xff319795)),
                      ),
                      width: 215,
                      height: 40,
                      decoration: BoxDecoration(
                        color: idx == 2 ? Color(0xff81E6D9) : Colors.transparent,
                        border: Border.all(
                          color: Color(0xffCBD5E0),
                          width: 1,
                        ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child:
                            LimitedBox(maxHeight: 200, maxWidth: 200, child: SvgPicture.asset(secondColumn[idx].image)),
                      ),
                      SizedBox(
                        width: 20,
                      ),
                  ...
                  Container(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child:
                            LimitedBox(maxHeight: 200, maxWidth: 200, child: SvgPicture.asset(thirdColumn[idx].image)),
                      ),
                      SizedBox(
                        height: 50,
                      )
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child:
                    PageView(padEnds: true, controller: _pageController, scrollDirection: Axis.horizontal, children: [
                  InkWell(
                    hoverColor: Color(0xff81E6D9).withOpacity(0.5),
                    splashColor: Color(0xff81E6D9),
                    onTap: () {
                  ...
                  InkWell(
                    ...
                    splashColor: Color(0xff81E6D9),
                    onTap: () {
                      _pageController.animateToPage(1, curve: Curves.easeIn, duration: Duration(milliseconds: 500));
                    },
                    child: Container(
                      alignment: Alignment.center,
                      child: Text(
                  ...
                  InkWell(
                    ...
                    splashColor: Color(0xff81E6D9),
                    onTap: () {
                      _pageController.animateToPage(2, curve: Curves.easeIn, duration: Duration(milliseconds: 500));
                    },
                    child: Container(
                      alignment: Alignment.center,
                      child: Text(
              ...
              Container(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 20.0),
                    child: LimitedBox(maxHeight: 200, maxWidth: 200, child: SvgPicture.asset(thirdColumn[idx].image)),
                  ),
                  SizedBox(
                    height: 50,
                  )
...
class CustomWidgetData {
  ...
  CustomWidgetData({required this.number, this.title, required this.description, required this.image});
}
